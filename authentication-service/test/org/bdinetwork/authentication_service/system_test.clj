...
(def association-config
  {:server-id                "EU.EORI.ASSOCIATION-REGISTER"
   ...
   :x5c                      (split-x5c (io/resource "test-config/association_register.x5c.pem"))
...
(def auth-server-config
  {:server-id                "EU.EORI.AUTHENTICATION-SERVICE"
   ...
   :x5c                      (split-x5c (io/resource "test-config/authentication_service.x5c.pem"))
   :port                     9992
...
(def client-config
  {:ishare/client-id          "EU.EORI.CLIENT"
   ...
   :ishare/x5c                (split-x5c (io/resource "test-config/client.x5c.pem"))
